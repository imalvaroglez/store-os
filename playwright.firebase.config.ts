...
export default defineConfig({
  ...
  testMatch: /(^|\/)(firebase|public-catalog|member-invite|purchase-ux2|smoke|responsive|theme)\.spec\.ts$/,
  ...
  projects: [
    ...
    {
      name: "foundation",
      testMatch: /(^|\/)(firebase|public-catalog|member-invite|purchase-ux2)\.spec\.ts$/,
    },
  ],
});
